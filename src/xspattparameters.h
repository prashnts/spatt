/* $Id: xspattparameters.h 440 2005-07-20 12:34:26Z mhoebeke $ */
/*
...
*/
#ifndef _XSPATTPARAMETERS_H
#define _XSPATTPARAMETERS_H

#include "spattparameters.h"

namespace spatt {
  class xspattparameters : public spattparameters {
  public:
    xspattparameters();
  };
