/* $Id: ldspattparameterparser.h 440 2005-07-20 12:34:26Z mhoebeke $ */
/*
...
*/
#ifndef _LDSPATTPARAMETERPARSER_H
#define _LDSPATTPARAMETERPARSER_H

#include "spattparameterparser.h"
#include "ldspattparameters.h"

namespace spatt {
  class ldspattparameterparser : public spattparameterparser {
  public:
    ldspattparameterparser();
    virtual ~ldspattparameterparser() {};
    virtual void parse(int, char **, spattparameters *);

 protected:
  SwitchArg *_preciseArg;
