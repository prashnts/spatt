/* $Id: xspattparameterparser.h 440 2005-07-20 12:34:26Z mhoebeke $ */
/*
...
*/
#ifndef _XSPATTPARAMETERPARSER_H
#define _XSPATTPARAMETERPARSER_H

#include "spattparameterparser.h"
#include "xspattparameters.h"

namespace spatt {
  class xspattparameterparser : public spattparameterparser {
  public:
    xspattparameterparser();
    virtual ~xspattparameterparser() {};
