/* $Id: sspattparameterparser.cc 440 2005-07-20 12:34:26Z mhoebeke $ */
/*
...
namespace spatt {
  ...
  sspattparameterparser::sspattparameterparser() : 
    spattparameterparser("sspatt",VERSION)
  ...
  void 
  sspattparameterparser::parse(int argc, char **argv,spattparameters *params)
 {

    sspattparameters *sparams=dynamic_cast<sspattparameters *>(params);      
