/* $Id: sspattparameterparser.h 440 2005-07-20 12:34:26Z mhoebeke $ */
/*
...
*/
#ifndef _SSPATTPARAMETERPARSER_H
#define _SSPATTPARAMETERPARSER_H

#include "spattparameterparser.h"
#include "sspattparameters.h"

namespace spatt {
  class sspattparameterparser : public spattparameterparser {
  public:
    sspattparameterparser();
    virtual ~sspattparameterparser() {};
