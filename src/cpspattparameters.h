/* $Id: cpspattparameters.h 440 2005-07-20 12:34:26Z mhoebeke $ */
/*
...
*/
#ifndef _CPSPATTPARAMETERS_H
#define _CPSPATTPARAMETERS_H

#include "spattparameters.h"

namespace spatt {
  class cpspattparameters : public spattparameters {
  public:
    cpspattparameters();
  };
