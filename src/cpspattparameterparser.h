/* $Id: cpspattparameterparser.h 440 2005-07-20 12:34:26Z mhoebeke $ */
/*
...
*/
#ifndef _CPSPATTPARAMETERPARSER_H
#define _CPSPATTPARAMETERPARSER_H

#include "spattparameterparser.h"
#include "cpspattparameters.h"

namespace spatt {
  class cpspattparameterparser : public spattparameterparser {
  public:
    cpspattparameterparser();
    virtual ~cpspattparameterparser() {};
